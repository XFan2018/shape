...
class ConfigFinetuneSilhouette:
    def __init__(self):
        # 1.string parameters
        self.__train_dir = "animal_silhouette_testing"
        ...
        self.__finetune_animal_dataset = AnimalDataset(root_dir=self.__test_dir,
                                                       loader=pil_loader,
                                                       extensions="tif",
                                                       transforms=self.__transform)

        self.loader_dataset = torch.utils.data.DataLoader(self.__finetune_animal_dataset,
