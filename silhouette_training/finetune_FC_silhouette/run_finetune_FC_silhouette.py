...
from project2.finetune_FC_silhouette.Vgg16Model_FC_finetune_silhouette import ConfigFinetuneSilhouette
from project2.finetune_FC_silhouette.finetune_FC_silhouette import finetune_model_FC_silhouette
...
def run_finetune():
    ...
    finetune_model_FC_silhouette(model=model,
