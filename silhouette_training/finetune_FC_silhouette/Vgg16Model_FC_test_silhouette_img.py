...
class ConfigTestImagenet:
    def __init__(self, block_size=224):
        # 1.string parameters
        self.__val_dir = "/Users/leo/PycharmProjects/summerProject/project1/imagenet_val_testing_dataset"
        ...
        self.__transform1 = transforms.Compose([transforms.RandomResizedCrop(224),
                                                ScrambleTransform(self.block_size),
                                                transforms.ToTensor(),
